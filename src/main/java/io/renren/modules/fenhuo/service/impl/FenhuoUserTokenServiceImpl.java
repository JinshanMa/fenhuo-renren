...
@Service("FenhuoUserTokenService")
public class FenhuoUserTokenServiceImpl extends ServiceImpl<FenhuoUserTokenDao, FenhuoUserTokenEntity> implements FenhuoUserTokenService {
    //12小时后过期
    ...
    public R createToken(long userId) {
        ...
        //判断是否生成过token
        FenhuoUserTokenEntity tokenEntity = this.getById(userId);
        if(tokenEntity == null){
            tokenEntity = new FenhuoUserTokenEntity();
    ...
    public void logout(long userId) {
        ...
        //修改token
        FenhuoUserTokenEntity tokenEntity = new FenhuoUserTokenEntity();
        tokenEntity.setUserId(userId);
        tokenEntity.setToken(token);
        this.updateById(tokenEntity);
    }
